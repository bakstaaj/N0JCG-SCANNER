...
for required in \
  ...
  docs/MILESTONES.md \
  docs/OP25_WRAPPER.md tools/p25_set_receiver_roles.sh tools/pi5_p25_rtl_role_probe.sh tools/pi5_p25_bringup_acceptance.sh docs/RTL_ROLE_MAPPING.md docs/PI_BRINGUP_ACCEPTANCE.md \
